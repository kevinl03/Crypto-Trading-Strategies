...
For the prediction model used in the paper-trading campaigns, $H = 1$ (predict the next snapshot's z-score), $w = 300$ snapshots, and $\text{MIN\_PERIODS} = 90$. Window length and MIN_PERIODS ($\tau$) selection is described in Section~\ref{sec:ablation}.
