...
On the same out-of-sample \textbf{test} set used for LightGBM, we score a sklearn Random Forest regressor~\cite{breiman2001random} trained on the same chronological feature matrix (a classical Random Forest baseline as a control within the tree family; Section~\ref{sec:results}). Primary live claims remain capacity-matched mechanical baselines on the validation panel.
