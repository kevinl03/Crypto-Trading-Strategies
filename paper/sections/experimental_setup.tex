...
We replay two mechanical trading rules on the live panel under the same capacity constraints ($\text{max\_open} = 50$), settlement proxy, and paper gate $\tau{=}0.9$ as the model:
