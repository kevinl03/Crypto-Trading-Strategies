...
Future work should extend live paper trading across regimes and venues to characterize edge persistence, extend the analysis to order-book-level data with bid-ask spread modeling, and investigate reinforcement learning for dynamic threshold optimization~\cite{ning2024advanced, carapeto2024deep}.
