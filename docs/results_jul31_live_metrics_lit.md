...
| **Ko, Lin, Do et al. (2023)** | Distance method; **208–236% gross** (Q1 2022) | Low for Sharpe; high for **gross vs net** | Reinforces reporting **gross proxy vs net** separately. Our Sharpe is gross-proxy only. |
